...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container">
            <form action="/dashboard/mustahik/{{$mustahik->id}}" method="POST">
                @method('put')
                @csrf
{{--                <div class="modal-body">--}}
                    <div class="mb-3"><label for="exampleFormControlInput1">Nama Muzakki</label><input class="form-control" name="nama_kategori" id="nama" type="text" placeholder="Nama Muzakki" value="{{$mustahik->nama_kategori}}" required></div>
                    <div class="mb-3"><label for="exampleFormControlInput1">Jumlah Tanggungan</label><input class="form-control" name="jumlah_hak" id="tanggungan" type="number" value="{{$mustahik->jumlah_hak}}" required></div>
