...
{{--                <div class="modal-body">--}}
                    <div class="mb-3"><label for="exampleFormControlInput1">Nama Mustahik</label>
                        <input class="form-control" name="nama" id="nama" type="text" placeholder="Nama Muzakki" readonly value="{{$warga->nama}}" required></div>
                    <div class="mb-3"><label for="exampleFormControlInput1" hidden>Jumlah Tanggungan</label>
                        <input class="form-control" name="hak" id="tanggungan" type="number" id="tanggungan" readonly hidden value="{{$warga->hak}}" required></div>
