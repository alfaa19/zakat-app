    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Mustahik Lainnya</h1>
            ...
            <div class="modal fade" id="inputData" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="inputData" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="/dashboard/lainnya" method="POST">
                            @csrf
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col text-center ">
                                    <form action="/dashboard/lainnya/{{$ln->id}}" method="post" >
                                        @csrf
                                        @method('delete')
                            ...
                            <td>
                                <div class="col text-center">
                                    <a  href="/dashboard/lainnya/{{$ln->id}}" class="btn btn-warning">Edit</a>
                                </div>
                            </td>
                        </tr>
