...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container">
            <form action="/dashboard/bayarzakat/{{$zakat->id}}" method="POST">
                @method('put')
                @csrf
{{--                <div class="modal-body">--}}
                    <div class="mb-3"><label for="exampleFormControlInput1">Nama Muzakki</label>
                        <input class="form-control" name="nama_kk" id="nama" type="text" placeholder="Nama Muzakki" readonly value="{{$zakat->nama_kk}}" required></div>
                    <div class="mb-3"><label for="exampleFormControlInput1">Jumlah Tanggungan</label>
                        <input class="form-control" name="jumlah_tanggungandibayar" id="tanggungan" type="number" id="tanggungan" readonly value="{{$zakat->jumlah_tanggungandibayar}}" required></div>
