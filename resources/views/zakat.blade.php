    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <a class="btn btn-primary" href="/dashboard/muzaki" > Tambah Data</a>
            </div>
                ...
                <table id="datatablesSimple">
                    ...
                    @foreach($zakat as $zk )
                        ...
                        <tr>
                            ...
                            <td>{{$zk->nama_kk}}</td>
                            <td>{{$zk->jenis_bayar}} </td>
                            <td>{{$zk->jumlah_tanggungandibayar}}</td>
                            <td>{{$zk->bayar_beras}} Kg</td>
                            <td>Rp. {{$zk->bayar_uang}}</td>
                            <td>
                                <div class="col text-center ">
                                    <form action="/dashboard/bayarzakat/{{$zk->id}}" method="post" >
                                        @csrf
                                        @method('delete')
                            ...
                            <td>
                                <div class="col text-center">
                                    <a  href="/dashboard/bayarzakat/{{$zk->id}}" class="btn btn-warning">Edit</a>
                                </div>
                            </td>
                        </tr>
