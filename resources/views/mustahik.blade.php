        ...
        <main>
            ...
            <div class="modal fade" id="inputData" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="inputData" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="/dashboard/mustahik" method="POST">
                            @csrf
                            <div class="modal-body">
                                <div class="mb-3"><label for="exampleFormControlInput1">Nama Kategori</label><input class="form-control" name="nama_kategori" id="nama" type="text" placeholder="Nama mustahik" autofocus required></div>
                                <div class="mb-3"><label for="exampleFormControlInput1">Jumlah Hak</label><input class="form-control" name="jumlah_hak" id="tanggungan" type="number" required></div>
                            </div>
            ...
            <div class="card-body">
                <table id="datatablesSimple">
                    ...
                    <tbody>
                    @foreach($mustahik as $mh )
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{$mh->nama_kategori}}</td>
                            <td>{{$mh->jumlah_hak}}</td>
                            <td>
                                <div class="col text-center ">
                                    <form action="/dashboard/mustahik/{{$mh->id}}" method="post" >
                                        @csrf
                                        @method('delete')
                            ...
                            <td>
                                <div class="col text-center">
                                    <a  href="/dashboard/mustahik/{{$mh->id }}" class="btn btn-warning">Edit</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
