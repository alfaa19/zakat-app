...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container">
            <form action="/dashboard/muzaki/{{$muzakki->id}}" method="POST">
                @method('put')
                @csrf
{{--                <div class="modal-body">--}}
                    <div class="mb-3"><label for="exampleFormControlInput1">Nama Muzakki</label><input class="form-control" name="nama" id="nama" type="text" placeholder="Nama Muzakki" value="{{$muzakki->nama}}" required></div>
                    <div class="mb-3"><label for="exampleFormControlInput1">Jumlah Tanggungan</label><input class="form-control" name="jumlah_tanggungan" id="tanggungan" type="number" value="{{$muzakki->jumlah_tanggungan}}" required></div>
                    <div class="mb-3"><label for="exampleFormControlInput1">Keterangan</label><textarea class="form-control" name="keterangan" id="keterangan" placeholder="Boleh Dikosongkan">{{$muzakki->keterangan}} </textarea> </div>

                <button class="btn btn-primary" type="Submit" value="Update">Save Changes</button>
            </form>
            </div>
        </main>
